...
class Ui_calendar(object):
    def setupUi(self, calendar):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/a21pablosp/Documents/BlancoMiguez/img/calendarday_January_month_calendari_1584.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
